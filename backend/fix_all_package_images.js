...
// Map ALL packages to correct image filenames that exist in public/images/packages/
// Based on the actual files available
const packageImages = {
  1: ['dubai-complete.jpg', 'dubai-luxury.jpg'], // Perfect Dubai & Abu Dhabi Escape
  2: ['bali-paradise.jpg', 'bali-luxury.jpg'], // Bali
  3: ['manali-adventure.jpg', 'shimla-manali.jpg'], // Manali
  4: ['paris-eiffel.jpg', 'europe-dream.jpg'], // Paris
  5: ['europe.jpg', 'europe-dream.jpg'], // Europe
...
async function fixAllImages() {
  try {
    console.log('Fixing image filenames for ALL packages...\n');
    ...
    for (const [packageId, images] of Object.entries(packageImages)) {
      try {
        ...
        if (result.rows.length > 0) {
          console.log(`✓ Updated ${result.rows[0].title} (${packageId})`);
        } else {
    ...
    console.log('\n✓ All package images fixed successfully!');
  } catch (error) {
