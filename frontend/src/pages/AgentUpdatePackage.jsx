...
const AgentUpdatePackage = () => {
    ...
    const [itinerary, setItinerary] = useState([
        { title: "", description: "", meals: { breakfast: false, lunch: false, dinner: false } }
    ]);
        ...
        const loadPackage = async () => {
            try {
                ...
                if (res.ok) {
                    ...
                    setItinerary(data.itinerary || [{ title: "", description: "", meals: { breakfast: false, lunch: false, dinner: false } }]);
                }
            } catch (err) {
                console.error(err);
            } finally {
        ...
        <div style={{ padding: "40px" }}>
            ...
            >
                ...
                <textarea
                    ...
                    style={{ ...formTextAreaStyle, gridColumn: "span 2" }}
                ...
                <input
                    ...
                    value={packageData.offer_percent}
                    onChange={(e) => setPackageData({ ...packageData, offer_percent: e.target.value })}
                    style={{ padding: "12px", border: "1px solid #ccc", borderRadius: "8px" }}
                />

                <label style={{ display: "flex", alignItems: "center", gap: "10px", padding: "12px", border: "1px solid #ccc", borderRadius: "8px", background: "#f9fafb" }}>
                    <input
                        type="checkbox"
                        checked={packageData.is_featured}
                        onChange={(e) => setPackageData({ ...packageData, is_featured: e.target.checked })}
                    />
                    ...
                    {itinerary.map((day, index) => (
                        ...
                        >
                            ...
                            <div style={{ marginTop: "10px" }}>
                                <h5 style={{ marginBottom: "5px", fontSize: "14px" }}>Meals Included</h5>
                                <div style={{ display: "flex", gap: "15px", flexWrap: "wrap" }}>
                                    <label style={{ display: "flex", alignItems: "center", gap: "5px", fontSize: "14px" }}>
                                        <input
                                            ...
                                            onChange={(e) => {
                                                const updated = [...itinerary];
                                                if (!updated[index].meals) updated[index].meals = { breakfast: false, lunch: false, dinner: false };
                                                updated[index].meals.breakfast = e.target.checked;
                                                setItinerary(updated);
                                            }}
                                        />
                                        Breakfast
                                    ...
                                    <label style={{ display: "flex", alignItems: "center", gap: "5px", fontSize: "14px" }}>
                                        <input
                                            ...
                                            onChange={(e) => {
                                                const updated = [...itinerary];
                                                if (!updated[index].meals) updated[index].meals = { breakfast: false, lunch: false, dinner: false };
                                                updated[index].meals.lunch = e.target.checked;
                                                setItinerary(updated);
                                            }}
                                        />
                                        Lunch
                                    ...
                                    <label style={{ display: "flex", alignItems: "center", gap: "5px", fontSize: "14px" }}>
                                        <input
                                            ...
                                            onChange={(e) => {
                                                const updated = [...itinerary];
                                                if (!updated[index].meals) updated[index].meals = { breakfast: false, lunch: false, dinner: false };
                                                updated[index].meals.dinner = e.target.checked;
                                                setItinerary(updated);
                                            }}
                                        />
                                        Dinner
